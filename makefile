...
# Windows (cygwin)
ifeq "$(OS)" "Windows_NT"
	EXEEXT= #on windows applications must have .exe extension
	RM=del #rm command for windows powershell
    LDFLAGS = -DGLEW_STATIC -lglew32 -lfreeglut -lglu32 -lopengl32  -static-libstdc++ -static-libgcc
else
	# OS X
	OS := $(shell uname)
	ifeq ($(OS), Darwin)
...
$(PROGRAM_NAME): basicShapes.o shaderLoader.o textureLoader.o objLoader.o GameModel.o collectible.o camera.o main.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)
